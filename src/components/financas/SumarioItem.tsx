...
export default function ResumoItem(props: SumarioItemProps) {
    return(
        <div className={`
            relative fles flex-col bg-black
            pt-4 pb-3 px-5 rounded-lg
            border border-zinc-800 text-white
        `}>
            <div className="text-sm text-zinc-500">{props.titulo}</div>
            <div className="flex justify-between items-center">
                <span className={`text-2xl md:text-3xl font-black ${props.valorClassName ?? ''}`}>
